...
async def add_favorite(request: FavoriteCreate, current_user: dict = Depends(get_current_user)):
    ...
    created = sql_db.add_favorite(current_user["user_id"], cid, kp_id)
    return success({"course_id": cid, "kp_id": kp_id, "created": created})
...
async def remove_favorite(
    ...
    deleted = sql_db.remove_favorite(current_user["user_id"], cid, kp_id)
    return success({"course_id": cid, "kp_id": kp_id, "deleted": deleted})
